...
export const en: Dictionary = {
  ...
  resume: {
    ...
    certificates: [
      ...
      { title: 'Remote Work Professional Certification', period: '2023', place: 'Valencia-Spain Certiprof', file: 'assets/certificados/Certificate_Remote_Work_Professional_Certification.pdf' },
